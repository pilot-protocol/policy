...
Thanks for your interest in contributing to `policy` — Pilot Protocol policy plugin + policy expression language (expr-lang/expr backed).

## Quick start

```bash
git clone https://github.com/pilot-protocol/policy.git
cd policy
go test -race ./...
```
